...
(async () => {
  ...
  vm.runInContext(extractFn(html, 'isValidChatUid') + '\n' + extractFn(html, '_releaseChatFileRef') + '\n' + extractFn(html, '_releaseChatFileRefsOfMsg'), ctx2); // C200: dependencia transitiva del parche
